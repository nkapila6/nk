...
- **Easy class, low time effort**: I list this as a negative above but I understand different people are optimizing for different things in this degree, life is not easy and sometimes you just want a breather. This is the class for you! (if you get in _lol_)
...
## How to self study NLP?

Addressing the main question in the title. How does one self-study if they do not want to take this course?

Watch CS236 and CS224n from Stanford Online on YouTube.

1. CS236 shows how autoregressive modeling is not limited to text modality and sets a nice basis to language modeling. The mathematical formulation for different modalities really kept me hooked to this playlist.
2. CS224n hyperfocuses on language modeling and assumes a more advanced prior than GT's CS7650 does.
3. Implement a SLM from scratch - CS336 may be a good starting point for this.
4. Implement a image generation model from scratch (this is now a DL assignment, wasn't there when I took it)
5. Write your own inference framework if you want to look at the challenges during inference. LLMs are the future and understanding these system bottlenecks will be helpful imho.
6. others...?
