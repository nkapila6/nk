  ---
layout: post
title: "Algorthmic biases in supervised learning"
tags:
  - machine-learning
  - omscs
  - "#cs7641"
...
forked from [downey.io](https://downey.io/notes/omscs/cs7641/restriction-and-preference-bias-supervised-learning/) with additional ctx from me.
...
### Restriction Bias
Depends on the kernel chosen. Look into Linear vs non-linear kernels like RBF. There needs to be some way of calculating similarity between instances. See: [Mercer Condition](https://www.quora.com/Why-should-a-kernel-function-satisfy-Mercers-condition)

### Preference Bias
Seeks to maximize margin to avoid fitting too closely to the training data. See: [Hyperplane Separation Theorem](https://en.wikipedia.org/wiki/Hyperplane_separation_theorem)
